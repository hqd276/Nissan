...
<div class="booking-form col-sx-12 bg-white">
	<form class="form-horizontal col-sx-12" role="form" method="post" action="">
		<!-- <h2 class="text-uppercase">Booking form</h2> -->
		<img class="col-sx-12" src="<?php echo base_url();?>images/booking.jpg">
		...
		<div class="form-group col-sx-12">
			<label for="inputEmail3" class="col-sx-2 control-label">From</label>
			<div class="col-sx-4">
			...
			<label for="inputEmail3" class="col-sx-2 control-label">To</label>
			<div class="col-sx-4">
		...
		<div class="form-group col-sx-12">
			<label for="inputEmail3" class="col-sx-2 control-label">Phone</label>
			<div class="col-sx-10">
			  	<input type="phone" class="form-control" id="phone" name="phone" placeholder="Phone" value="<?php echo set_value('phone'); ?>">
			</div>
		</div>
		<div class="form-group col-sx-12">
			<label for="inputEmail3" class="col-sx-2 control-label">Content</label>
			<div class="col-sx-10">
