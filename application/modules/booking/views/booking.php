...
<div class="booking-form col-xs-12 bg-white">
	<form class="form-horizontal col-xs-12" role="form" method="post" action="">
		<!-- <h2 class="text-uppercase">Booking form</h2> -->
		<img class="col-xs-12" src="<?php echo base_url();?>images/booking.jpg">
		...
		<div class="form-group col-xs-12">
			<label for="inputEmail3" class="col-xs-2 control-label">From</label>
			<div class="col-xs-4">
			...
			<label for="inputEmail3" class="col-xs-2 control-label">To</label>
			<div class="col-xs-4">
		...
		<div class="form-group col-xs-12">
			<label for="inputEmail3" class="col-xs-2 control-label">Content</label>
			<div class="col-xs-10">
