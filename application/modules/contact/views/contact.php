...
<div class="contact-form col-sx-12 bg-white">
	...
	<form class="form-horizontal  col-sx-8" role="form" method="post" action="<?php echo base_url();?>contact">
		...
		<div class="form-group col-sx-12">
			<label for="inputEmail3" class="col-sx-2 control-label">Số điện thoại</label>
			<div class="col-sx-10">
			  	<input type="" class="form-control" id="inputEmail3" name="phone" placeholder="Số điện thoại" value="<?php echo set_value('phone'); ?>">
			</div>
		</div>
		<div class="form-group col-sx-12">
			<label for="inputEmail3" class="col-sx-2 control-label">Nội dung</label>
			<div class="col-sx-10">
