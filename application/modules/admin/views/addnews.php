...
<div class="contact-form col-xs-12 bg-white">
	...
	<form class="form-horizontal col-md-12" role="form" method="post" enctype="multipart/form-data" action="">
		...
		<div class="form-group col-xs-12">
			<label for="inputEmail3" class="col-xs-2 control-label">Category</label>
			<div class="col-xs-10">
		...
		<div class="form-group col-xs-12">
			<label for="inputEmail3" class="col-xs-2 control-label">Information</label>
			<div class="col-xs-10">
		...
		<div class="form-group col-xs-12">
			<label for="inputEmail3" class="col-xs-2 control-label">Hot News</label>
			<div class="col-xs-10">
				<input type ="checkbox" name="hot_news" value="1" <?php echo ($item['hot_news'] == 1)?"checked":""; ?>>
			</div>
		</div>
		<div class="form-group col-xs-12">
			<label for="inputEmail3" class="col-xs-2 control-label">Home News</label>
			<div class="col-xs-10">
				<input type ="checkbox" name="home_news" value="1" <?php echo ($item['home_news'] == 1)?"checked":""; ?>>
			</div>
		</div>
		<div class="form-group col-xs-12">
			<label for="inputEmail3" class="col-xs-2 control-label">Video News</label>
			<div class="col-xs-10">
