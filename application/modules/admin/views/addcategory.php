<div class="contact-form col-sx-12 bg-white">
	...
	<form class="form-horizontal col-md-12" role="form" method="post" enctype="multipart/form-data" action="">
		...
		<div class="form-group col-sx-12">
			<label for="inputEmail3" class="col-sx-2 control-label">Name</label>
			<div class="col-sx-10">
		...
		<div class="form-group col-sx-12">
			<label for="inputEmail3" class="col-sx-2 control-label">Parent</label>
			<div class="col-sx-10">
		...
		<div class="form-group col-sx-12">
			<label for="inputEmail3" class="col-sx-2 control-label">Active</label>
			<div class="col-sx-10">
