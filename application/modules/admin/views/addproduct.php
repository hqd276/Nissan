		...
		<div class="tab-content">
			<div id="detail"  class="tab-pane active" >
				<div class="form-group col-sx-12">
					<label for="inputEmail3" class="col-sx-2 control-label">Title</label>
					<div class="col-sx-10">
					  	<input type="" class="form-control" id="inputEmail3" name="title" placeholder="Title" value="<?php echo $item['title']; ?>">
					</div>
				</div>
				<div class="form-group col-sx-12">
					<label for="inputEmail3" class="col-sx-2 control-label">Url</label>
					<div class="col-sx-10">
					  	<?php echo $item['slug']; ?>
					</div>
				</div>
				<div class="form-group col-sx-12">
					<label for="inputEmail3" class="col-sx-2 control-label">Image</label>
					<div class="col-sx-10">
						<?php 
						if ($item['image']!='') {
			...
			<div id="furniture" class="tab-pane" >
				...
				<div class="form-group col-sx-12 furniture core hidden">
					<label for="inputEmail3" class="col-sx-2 control-label">Image</label>
					<div class="col-sx-10">
			...
			<div id="exterior" class="tab-pane" >
				...
				<div class="form-group col-sx-12 exterior core hidden">
					<label for="inputEmail3" class="col-sx-2 control-label">Image</label>
					<div class="col-sx-10">
			...
			<div id="meta" class="tab-pane" >
				<div class="form-group col-sx-12">
					<label class="col-sx-3 control-label">Tiêu đề</label>
					<div class="col-sx-9">
						<input class="form-control" name="meta_title" value="<?php echo $item['meta_title']; ?>">
					</div>
				</div>
				<div class="form-group col-sx-12">
					<label class="col-sx-3 control-label">Từ khóa</label>
					<div class="col-sx-9">
						<input class="form-control" name="meta_keyword" value="<?php echo $item['meta_keyword']; ?>">
					</div>
				</div>
				<div class="form-group col-sx-12">
					<label class="col-sx-3 control-label">Giới thiệu</label>
					<div class="col-sx-9">
